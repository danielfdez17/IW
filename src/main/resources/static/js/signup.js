...
document.addEventListener("DOMContentLoaded", () => {
    const div = document.getElementById("checkbox-generator")
    ...
    for (let i = 0; i < MAX; ++i) {
        ...
        input.value = random;
        input.id = `random${i}`;
        input.className = "col-md-auto btn-check";
        input.type = "checkbox";
        input.addEventListener("click", () => {
            ...
            console.warn(`Pares totales: ${totalPares}; Pares pulsados: ${totalParesPulsados}`)
        })
