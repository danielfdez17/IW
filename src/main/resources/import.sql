...
INSERT INTO IWUser (id, enabled, roles, username, password, first_name, last_name, available_money)
VALUES (1, TRUE, 'ADMIN,USER', 'a',
    '{bcrypt}$2a$10$2BpNTbrsarbHjNsUWgzfNubJqBRf.0Vz9924nRSHBqlbPKerkgX.W', 'Jose1', 'V', 1000);
INSERT INTO IWUser (id, enabled, roles, username, password, first_name, last_name, available_money)
VALUES (2, TRUE, 'USER', 'b',
    '{bcrypt}$2a$10$2BpNTbrsarbHjNsUWgzfNubJqBRf.0Vz9924nRSHBqlbPKerkgX.W', 'Jose2', 'V', 1000);
INSERT INTO IWUser (id, enabled, roles, username, password, first_name, last_name, available_money)
VALUES (3, TRUE, 'USER', 'c',
    '{bcrypt}$2a$10$2BpNTbrsarbHjNsUWgzfNubJqBRf.0Vz9924nRSHBqlbPKerkgX.W', 'Jose3', 'V', 1000);
INSERT INTO IWUser (id, enabled, roles, username, password, first_name, last_name, available_money)
